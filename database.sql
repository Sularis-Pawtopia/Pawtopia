...
-- CREATE POLICY "Allow authenticated uploads" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'pet-images');
-- CREATE POLICY "Allow public reads" ON storage.objects FOR SELECT TO public USING (bucket_id = 'pet-images');
