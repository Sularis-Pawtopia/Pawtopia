...
export default async function DvmfOnboardingPage() {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">DVMF Registration</h1>
          <p className="text-gray-600">
            Complete your official facility profile to access reports and manage services.
          </p>
